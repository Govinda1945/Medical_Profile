        ...
        <div class="container bg-primary text-white" style="width: 70%; height:90%;">
            <form class="form" id="myForm" method="POST" onsubmit="return validateForm()" name="myForm" action="login.php">
                ...
                <div class="row text-center">
                    ...
                    <div class=" col-md-9">
                        <input required class="form-control inputs" placeholder="Enter your Licence Id" type="text" name="flicence" id="flicence">
                ...
                <div>
                    <button style="width: 100%; padding:5px; " class="btn btn-danger text-center" name="hospitalsignup">Signup</button>
