...
<body><br>
    ...
    <a style="margin-right: 2%;" class="btn btn-success float-end mt-0 " type="submit" href="hospitalhome.php">Back</a>
    ...
    <section class="disnone">
        ...
        <div style="margin: 0 2%;" class="row m-5"><br><br><br>
            <div class="col-md-9" style="width:60%; margin:2% 10px; border:2px solid black; border-radius:10px; padding:2%;">
                ...
                <h5 class="float-end m-1">Adhar No : <span></span></h5>
                <b>
                    <h2><span class="fas fa-user-alt"></span> </h2>
                </b>
